    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-2xl mx-auto p-4 space-y-4">
        ...
        <Card className="p-2 divide-y divide-border">
          ...
          >
            <div className="w-9 h-9 rounded-full bg-yellow-400/15 text-yellow-400 flex items-center justify-center">
              <DollarSign className="w-4 h-4" />
            </div>
            <div className="flex-1">
              <div className="text-sm font-medium">Mercado de jogadores</div>
              <div className="text-[11px] text-muted-foreground">
                Veja seu valor de mercado e o ranking
              </div>
            </div>
